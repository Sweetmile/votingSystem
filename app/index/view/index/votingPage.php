    ...
    <div class="am-u-sm-8">
        ...
        <section data-am-widget="accordion" class="am-accordion am-accordion-default">
            ...
            <div class="am-accordion-content">
                ...
                <button type="button" class="am-btn am-btn-primary am-btn-block">投&nbsp;票</button>
            </div>
            </dd>
            </dl>
        </section>
...
<script src="{$Think.config.WEB_ROOT}/public/static/js/voting.js"></script>
<script>
    var rootUrl = "{$Think.config.WEB_ROOT}";
    var name = "{$user.name}";
    var id = "{$vote.id}";
    var admin = "{$user.admin}";
    var maxNumber = "{$vote.vote_number}";
</script>
</body>
</html>
